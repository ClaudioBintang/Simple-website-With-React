    ...
    >
      <div className="max-w-xl lg:max-w-3xl">
        <div className="relative block -mt-16 lg:hidden">
          <a
            className="inline-flex items-center justify-center text-blue-600 bg-white rounded-full size-16 sm:size-20 dark:bg-gray-900"
            href="#"
          >
            <span className="sr-only">Home</span>
            <svg
        ...
        <form action="#" className="grid grid-cols-6 gap-6 mt-8">
          ...
          <div className="col-span-6">
            <label htmlFor="MarketingAccept" className="flex gap-4">
              <input
                ...
                className="bg-white border-gray-200 rounded-md shadow-sm size-5 dark:border-gray-700 dark:bg-gray-800 dark:focus:ring-offset-gray-900"
              />
          ...
          <div className="col-span-6 sm:flex sm:items-center sm:gap-4">
            <button
              className="inline-block px-12 py-3 text-sm font-medium text-white transition bg-blue-600 border border-blue-600 rounded-md shrink-0 hover:bg-transparent hover:text-blue-600 focus:outline-none focus:ring active:text-blue-500 dark:hover:bg-blue-700 dark:hover:text-white"
            >
              Create an account
            </button>
